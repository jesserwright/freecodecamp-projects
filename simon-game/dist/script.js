...
class App extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",

    {
      ...
      moveOrder: 0,
      countNum: 0 });_defineProperty(this, "toggleButtonRun",
    ...
    });_defineProperty(this, "buttonPress",
    ...
    });}playSound(audioURL) {let sound = new Audio(audioURL);sound.play();}playDelayedSound(audioURL) {setTimeout(() => this.playSound(audioURL), 100);}playDelayedToggle(el) {setTimeout(() => this.toggleButtonRun(el), 100);el.style.opacity = '.7';}runGamePattern(i) {const buttonPattern = this.state.buttonPattern;const moveOrder = this.state.moveOrder;const el = document.getElementsByClassName(buttonPattern[i])[0];this.playDelayedSound(buttonsData[buttonPattern[i]]);this.playDelayedToggle(el);}runGamePatternLoop(howMany) {const that = this;let i = 0;function delayGame() {that.runGamePattern(i);i++;if (i <= howMany) {setTimeout(() => delayGame(), 1000);}}delayGame();}

  render() {

    const buttonsElements = Object.keys(buttonsData).map((val, idx) => /*#__PURE__*/
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("h2", null, "Simon Game ", /*#__PURE__*/React.createElement("i", { className: "volume up icon" })), /*#__PURE__*/
      React.createElement("div", { className: "simon-grid" }, /*#__PURE__*/
      React.createElement("div", { className: "controls-circle" }, /*#__PURE__*/
      React.createElement("div", { className: "simon-title" }, "SIMON"), /*#__PURE__*/
      React.createElement("span", null, /*#__PURE__*/
      React.createElement("div", { className: "start-reset", onClick: this.startGame }, "Start/Reset")), /*#__PURE__*/

      React.createElement("div", { className: "count" }, "Count: ", this.state.countNum)),
